...
protected:
  ...
  void Load(physics::WorldPtr world, sdf::ElementPtr sdf) {
    ...
    // get the list of experimental subject models from the configuration 
    if( !sdf->HasElement("models") ) {
      gzerr << "Unable to find parameter: models\n";
      return;
    } 
  ...
  void Postupdate( ) {
    ...
    _solution = Reveal::Sim::Gazebo::helpers_c::read_client_solution( _world, _model_list, _trial->scenario_id );
